...
export function LogoMark({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
    >
      <rect width="48" height="48" rx="10" className="fill-foreground" />
      ...
      >
        ...
        <circle cx="7" cy="17" r="2" className="fill-background" stroke="none" />
        <circle cx="17" cy="17" r="2" className="fill-background" stroke="none" />
      </g>

      {/* Point d'accent */}
      <circle cx="37" cy="12" r="3" className="fill-accent" />
    </svg>
  );
}
